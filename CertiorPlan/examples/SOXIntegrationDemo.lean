...
#widget CertiorPlan.verificationExplorerWidget with soxWidgetProps

-- Compliant scenario (uncomment to use):
def soxCompliantProps : CertiorPlan.WidgetInitProps := { planInfo := earningsCompliant }
#widget CertiorPlan.verificationExplorerWidget with soxCompliantProps
